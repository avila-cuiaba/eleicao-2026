  ...
  CONTRATOS: {
    ...
    CAMPOS_FORMULARIO: [
      ...
      },
      {
        ...
        indice: 4,
        largura: 6,
        grupo: "documentos-nascimento-celular",
      },
      {
        id: "celular",
        aliases: ["celular", "telefone", "cel"],
        rotulo: "celular",
        tipo: "celular",
        indice: 3,
        largura: 6,
...
CONFIG.PESSOAL_PAGAMENTOS = Object.assign({}, CONFIG.CONTRATOS, {
  ...
  /** Colunas Q–X: pgto 1 / data 1 … pgto 4 / data 4 (16–23); Y/Z: pgto-parceiro / data (25–26). */
